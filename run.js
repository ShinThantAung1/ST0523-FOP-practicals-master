...
const topicId = parseInt(currentFolder.match(/^(\d+)/)?.[1]);

if (!questionNumber) {
  console.error('❌ Please provide the question folder. Example: node sendcode.js q1');
  process.exit(1);
}

const filePath = `./${questionNumber}/code.js`;
